...
with app.app_context(): 
    ...
    f1 = FoundItem(name="Found Phone", description="A smartphone, black color.", reward=100, place_lost="Nairobi", user=u1, image_url="https://i.pcmag.com/imagery/reviews/01Tnfpimnk3LJiQtnOa11eJ-10.fit_lim.size_919x518.v1711724157.jpg")
    f2 = FoundItem(name="Found Wallet", description="A leather wallet with ID cards.", reward=50, place_lost="Mombasa", user=u2, image_url="https://godbolegear.com/cdn/shop/files/Hand_Grained_Leather_Wallet_in_Chestnut_Leather.jpg?v=1717913883&width=1946")
    f3 = FoundItem(name="Found Watch", description="A gold wristwatch.", reward=200, place_lost="Kisumu", user=u3, image_url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRrrvRWDpRts3ffsdJKXCCqzfSaLNGc2Bxc5g&s")
    f4 = FoundItem(name="Found Bag", description="A large brown bag with clothes.", reward=150, place_lost="Nakuru", user=u4, image_url="https://www.purpink.co.ke/cdn/shop/files/3aaf440c-a6dd-48e2-9240-c3ccb345b8c0_enjoy_tote.jpg?v=1720507498")
    f5 = FoundItem(name="Found Keys", description="A set of house keys.", reward=20, place_lost="Eldoret", user=u5, image_url="https://www.welovekeys.co.uk/wp-content/uploads/2021/03/Federal-Keys.jpg")
    f6 = FoundItem(name="Found Glasses", description="A new pair.", reward=100, place_lost="kajiado", user=u6, image_url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIUPLOUQCOUu7naEVOwCSE0I7kPyAa8w4-EA&s")
    f7 = FoundItem(name="Found Mouse", description="A white fancy mouse.", reward=50, place_lost="Voi", user=u7, image_url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQx3qARXQdkyZYhkR35oeGLmLoIWjODSqbNbA&s")
    f8 = FoundItem(name="Found Header", description="A black header.", reward=200, place_lost="Kapsabet", user=u8, image_url="https://res.cloudinary.com/agrimark/image/upload/v1683295833/uploads/assets/673973-1-a-Electricmate-Heavy-Duty-Rubber-Plug-Top-bdc2f5.jpg")
    f9 = FoundItem(name="Found Phone case", description="A white iphone case.", reward=150, place_lost="Limuru", user=u9, image_url="https://i5.walmartimages.com/seo/Clear-with-Silver-Glitter-Phone-Case-for-iPhone-12-iPhone-12-Pro_ab6d059c-6d4c-48ca-82dc-c36a6a5bc3d3.0df8ac93200e691c4862fd8396f743ed.jpeg")
    f10 = FoundItem(name="Found Bottle", description="A set of blue bottles.", reward=20, place_lost="Kinangop", user=u10, image_url="https://oceanbottle.co/cdn/shop/products/OceanBottle_OG_Front_Ocean-Blue_2048px.jpg?v=1653562177")
